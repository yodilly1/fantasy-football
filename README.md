...
2. Apply migrations `0006_authenticated_workflows.sql`, `0007_seed_2026_league_and_invites.sql`, `0008_atomic_keeper_selection.sql`, `0009_rollover_snapshot_import.sql`, `0010_build_auction_pool.sql`, `0011_workbook_rule_reconciliation.sql`, and `0012_server_keeper_rule_validation.sql` in the Supabase SQL editor.
